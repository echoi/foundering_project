...
\begin{tabular}{ l l l l } 
    ...
    SCSZ & N$180^\circ$E, 40$^\circ$ SW & thrust & \citet{chapman2016modern}\\    
    \hline
\end{tabular}
 \begin{tablenotes}
    \begin {small}
...
is about 2 MPa in the GCSZ and in the northern segment of the ETSZ for their optimal fault orientations (Fig.~\ref{ht_hm_cs}a). On the other hand, the calculated $\Delta$C$_{HT-HM}$ reduces the tendency to slip for a fault plane optimally oriented at the NMSZ\_NE and the ETSZ (Fig.~\ref{ht_hm_cs}b). The mantle heterogeneity reduce the Coulomb stresses relative to the homogeneous mantle for the optimally oriented faults at the CVSZ and the SCSZ (Fig.~\ref{ht_hm_cs}c,d. 
