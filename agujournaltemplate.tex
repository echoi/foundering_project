...
\begin{abstract}
Our understanding of earthquake generation in the Central and Eastern US (CEUS) remains obscure due to various local stress contributions to it, far from the plate boundaries. This study investigates stress effects of upper mantle heterogeneity at the major seismic zones in CEUS by utilizing a recent P wave tomography study by \citet{Biryol_2016}. We set up instantaneous 3D numerical models based on temperatures converted from the tomography results. Models have dislocation and diffusion creep rheology calculated from these temperatures. We isolate all the heterogeneity deeper than 200 km in one model setup and additionally, a high density feature interpreted as lithospheric root by \citet{Biryol_2016} in another. Model results attributed to all the upper mantle heterogeneity show high differential stress and Coulomb stress at the optimal fault orientations of the seismic zones. However, the sole effect of root show stress concentration only at the seismic zones in the vicinity of the root: Eastern Tennessee Seismic Zone and the northeast arm of the New Madrid Seismic Zone. We also discuss the Coulomb stress from our models at a range of theoretical fault orientations and dips. Our findings imply that upper mantle structures below the CEUS has notable contribution in increasing the stress state at the seismic zones. Moreover, these heterogeneities increase the Coulomb stress at preexisting faults in the seismic zones, generating earthquakes.
