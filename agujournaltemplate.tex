...
%region's earthquakes that are missed by a predicting quantityEach curve, \{$x,y$\}, is plotted for the range of values of a predictor, and for each value $p$, fraction number of missed earthquakes that lie within the region where predictor values are less than that value, $p$, are plotted against the fraction of predictor values below $p$. 
